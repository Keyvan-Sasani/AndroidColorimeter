...
public class ConsumptionDatabaseHelper extends SQLiteOpenHelper
{
	...
	public void onCreate(SQLiteDatabase db)
	{
		...
		db.execSQL(ConsumptionContract.SQL_INITIALIZE_FOODS_2);
		db.execSQL(ConsumptionContract.SQL_INITIALIZE_FOODS_3);
		db.execSQL(ConsumptionContract.SQL_INITIALIZE_FOODS_4);
		db.execSQL(ConsumptionContract.SQL_INITIALIZE_FOODS_5);
