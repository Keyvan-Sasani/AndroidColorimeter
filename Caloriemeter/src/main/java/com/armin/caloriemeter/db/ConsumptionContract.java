...
public final class ConsumptionContract
{
	...
	public static final String SQL_CREATE_FOODS =
			"CREATE TABLE IF NOT EXISTS " + FoodEntry.TABLE_NAME + " (\n" +
					...
					FoodEntry.COLUMN_NAME_URL + TEXT_TYPE + ")";
	public static final String SQL_INITIALIZE_FOODS = Constants.INSERT_INTO_FOODS;
	public static final String SQL_INITIALIZE_FOODS_2 = Constants.INSERT_INTO_FOODS_2;
	public static final String SQL_INITIALIZE_FOODS_3 = Constants.INSERT_INTO_FOODS_3;
	public static final String SQL_INITIALIZE_FOODS_4 = Constants.INSERT_INTO_FOODS_4;
	public static final String SQL_INITIALIZE_FOODS_5 = Constants.INSERT_INTO_FOODS_5;
